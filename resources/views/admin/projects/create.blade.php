        ...
        <form method="POST" action="{{ route('admin.projects.store') }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" id="title" name="title" class="form-input" placeholder="e.g. Red Panda Survey" value="{{ old('title') }}" required>
                </div>
                <div>
            ...
            <div class="mb-6">
                ...
                <textarea id="description" name="description" class="form-input h-20 resize-none" placeholder="A short description shown in project listings..." required>{{ old('description') }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                    ...
                    <p class="text-text-muted text-xs mt-1">JPEG, PNG or WebP · Auto-resized to 1200×800, saved as WebP</p>
            ...
            <div class="mb-8">
                <label class="flex items-center gap-3 cursor-pointer">
                    <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }} class="w-5 h-5 text-primary-accent rounded border-glass-border/30 bg-glass-light/10 focus:ring-primary-accent focus:ring-offset-dark-bg">
